...
```mermaid
flowchart TD
    A["<img src='/images/icons/homeassistant.svg' width='28'/><br/>Home Assistant<br/>Parents Dashboard"] -->|"REST POST<br/>action / group / key"| B["<img src='/images/icons/openwrt.svg' width='28'/><br/>OpenWRT Router<br/>CGI /cgi-bin/curfew"]
    B --> C{Action?}
